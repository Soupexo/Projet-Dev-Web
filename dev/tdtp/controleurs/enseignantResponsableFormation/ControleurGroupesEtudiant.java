 ...
 */
public class ControleurGroupesEtudiant implements ActionListener {
  ...
  private VueGroupesEtudiant vueGroupesEtudiant;
  private PanelCardLayout panelPrincipal;
     ...
     */
  public ControleurGroupesEtudiant(PanelCardLayout panelPrincipal) {
    this.panelPrincipal = panelPrincipal;
    this.cardLayout = (CardLayout) panelPrincipal.getLayout();
    this.vueGroupesEtudiant = (VueGroupesEtudiant) panelPrincipal.getVue("GESTION_GROUPES_RESPONSABLE_FORMATION");

    vueGroupesEtudiant.getNotes().addActionListener(this);
    vueGroupesEtudiant.getPromotion().addActionListener(this);
    vueGroupesEtudiant.getSondages().addActionListener(this);
    vueGroupesEtudiant.getGroupes().addActionListener(this);
  }
