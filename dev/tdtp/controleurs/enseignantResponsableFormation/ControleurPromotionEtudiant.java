 ...
 */
public class ControleurPromotionEtudiant implements ActionListener {
  ...
  private VuePromotionEtudiant vuePromotionEtudiant;
  private PanelCardLayout panelPrincipal;
     ...
     */
  public ControleurPromotionEtudiant(PanelCardLayout panelPrincipal) {
    this.panelPrincipal = panelPrincipal;
    this.cardLayout = (CardLayout) panelPrincipal.getLayout();
    this.vuePromotionEtudiant = (VuePromotionEtudiant) panelPrincipal.getVue("GESTION_PROMOTION_RESPONSABLE_FORMATION");

    vuePromotionEtudiant.getNotes().addActionListener(this);
    vuePromotionEtudiant.getPromotion().addActionListener(this);
    vuePromotionEtudiant.getSondages().addActionListener(this);
    vuePromotionEtudiant.getGroupes().addActionListener(this);
