<?php
    ...
    static private $database = 'saes3-obenbou'; // votre id court
    static private $login ='saes3-obenbou'; // votre id court
    static private $password = 'nZt41vmdyOPqYdct'; // votre mdp
