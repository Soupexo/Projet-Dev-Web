...
<body>
    ...
    <form method="POST" action="routeur.php?controleur=controleurEnseignant&action=supprimer">
        <label for="login">Login de l'enseignant à supprimer :</label>
        <input type="text" id="login" name="login" required>
        <button type="submit">Supprimer l'enseignant</button>
    </form>
</body>
</html>
