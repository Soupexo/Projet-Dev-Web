<div class="container promotion-page">
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;">
        ...
        <p style="display:flex;gap:8px;">
            ...
            <a class="btn btn-secondary" href="routeur.php?controleur=controleurPromotion&action=afficherLog">Voir logs</a>
        </p>
    </div>
    ...
    <?php if (!empty($promotions)): ?>
        ...
        <table class="table-data">
            <thead>
                <tr>
                    <th>ID <br><small class="muted">(num_p)</small></th>
                    <th>Année <br><small class="muted">(intitule_a / num_a)</small></th>
                    <th>Nb groupes max <br><small class="muted">(nombre_de_groupe_max_p)</small></th>
                    <th>Nb étudiants max <br><small class="muted">(nombre_etudiant_max_p)</small></th>
                    <th>Covoiturage max <br><small class="muted">(nombre_etudiant_max_covoiturage_p)</small></th>
                    <th>Actions</th>
                </tr>
            </thead>
            <tbody>
